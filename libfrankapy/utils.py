...
def interpolate_joint_positions(start: List[float], end: List[float], t: float) -> List[float]:
...
def compute_cartesian_distance(pose1: List[float], pose2: List[float]) -> Tuple[float, float]:
