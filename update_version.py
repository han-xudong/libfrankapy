...
def main():
    ...
    parser.add_argument(
        "version", 
        help="New version number (e.g., 1.0.0)"
    )
    parser.add_argument(
        "--dry-run", 
        action="store_true", 
    ...
    if args.dry_run:
        ...
        print(f"   2. Commit the changes: git add . && git commit -m 'chore: bump version to {args.version}'")
        print(f"   3. Create and push tag: git tag v{args.version} && git push origin v{args.version}")
