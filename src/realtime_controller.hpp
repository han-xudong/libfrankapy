 ...
 * 
 * This file defines the real-time controller that manages the libfranka control loop
 * while communicating with Python through shared memory.
 */
...
private:
     ...
     */
    void convert_robot_state(
        const franka::RobotState& franka_state,
...
private:
    ...
    void calculate_trajectory_time(const std::array<double, 7>& current_positions);
};
...
public:
    CartesianPositionMotionGenerator(
...
private:
    ...
    std::array<double, 16> interpolate_pose(
