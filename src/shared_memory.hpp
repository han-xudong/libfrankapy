 ...
 * @brief Shared memory data structures for real-time communication between Python and C++
 * 
 * This file defines atomic data structures used for communication between the Python
 * high-level interface and the C++ real-time control loop through shared memory.
 */
...
struct RealtimeState {
    ...
    std::array<std::atomic<double>, 3> cartesian_angular_velocity; // [wx, wy, wz]
    
    // External forces and torques
    std::array<std::atomic<double>, 6> external_wrench; // [fx, fy, fz, tx, ty, tz]
