...
def main():
    ...
    print(f"LibFrankaPy State Monitoring Example")
    ...
    try:
        ...
        monitor = RobotStateMonitor(robot, update_rate=10.0)  # 10 Hz updates
        
        # Start monitoring
        monitor.start_monitoring()
        
        # Start input thread for emergency stop
        ...
        # Monitor for a while or until interrupted
        try:
            while monitor.monitoring:
                time.sleep(0.1)
